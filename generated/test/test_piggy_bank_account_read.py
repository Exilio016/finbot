...
class TestPiggyBankAccountRead(unittest.TestCase):
    """PiggyBankAccountRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PiggyBankAccountRead:
        """Test PiggyBankAccountRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PiggyBankAccountRead`
        """
        model = PiggyBankAccountRead()
        if include_optional:
    ...
    def testPiggyBankAccountRead(self):
        """Test PiggyBankAccountRead"""
