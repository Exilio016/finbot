...
class TestUserGroupReadAttributes(unittest.TestCase):
    """UserGroupReadAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserGroupReadAttributes:
        """Test UserGroupReadAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserGroupReadAttributes`
        """
        model = UserGroupReadAttributes()
        if include_optional:
    ...
    def testUserGroupReadAttributes(self):
        """Test UserGroupReadAttributes"""
