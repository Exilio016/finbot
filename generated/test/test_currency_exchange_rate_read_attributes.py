...
class TestCurrencyExchangeRateReadAttributes(unittest.TestCase):
    """CurrencyExchangeRateReadAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrencyExchangeRateReadAttributes:
        """Test CurrencyExchangeRateReadAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyExchangeRateReadAttributes`
        """
        model = CurrencyExchangeRateReadAttributes()
        if include_optional:
    ...
    def testCurrencyExchangeRateReadAttributes(self):
        """Test CurrencyExchangeRateReadAttributes"""
