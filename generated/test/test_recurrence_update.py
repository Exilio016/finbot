    ...
    def make_instance(self, include_optional) -> RecurrenceUpdate:
        ...
        if include_optional:
            return RecurrenceUpdate(
                ...
                notes = 'Some notes',
                repetitions = [
                    openapi_client.models.recurrence_repetition_update.RecurrenceRepetitionUpdate(
                        type = 'weekly', 
                        moment = '3', 
                        skip = 0, 
                        weekend = 1, )
                ...
                transactions = [
                    openapi_client.models.recurrence_transaction_update.RecurrenceTransactionUpdate(
