...
class TestCronResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CronResult:
        ...
        if include_optional:
            return CronResult(
                recurring_transactions = openapi_client.models.cron_result_row.CronResultRow(
                    job_fired = True, 
                    job_succeeded = True, 
                    job_errored = False, 
                    message = 'Cron result message', ),
                auto_budgets = openapi_client.models.cron_result_row.CronResultRow(
                    job_fired = True, 
                    job_succeeded = True, 
                    job_errored = False, 
                    message = 'Cron result message', ),
                telemetry = openapi_client.models.cron_result_row.CronResultRow(
                    job_fired = True, 
                    job_succeeded = True, 
                    job_errored = False, 
                    message = 'Cron result message', )
