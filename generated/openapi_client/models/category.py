...
class Category(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "name", "notes", "native_currency_id", "native_currency_code", "native_currency_symbol", "native_currency_decimal_places", "spent", "earned"]
