...
class AvailableBudget(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places", "native_currency_id", "native_currency_code", "native_currency_symbol", "native_currency_decimal_places", "amount", "native_amount", "start", "end", "spent_in_budgets", "spent_outside_budget"]
