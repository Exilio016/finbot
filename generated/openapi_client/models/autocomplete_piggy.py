...
class AutocompletePiggy(BaseModel):
    ...
    currency_id: Optional[StrictStr] = Field(default=None, description="Currency ID for this piggy bank. This will always be the currency of the piggy bank, never the user's native currency.")
    currency_code: Optional[StrictStr] = Field(default=None, description="Currency code for this piggy bank. This will always be the currency of the piggy bank, never the user's native currency.")
    currency_symbol: Optional[StrictStr] = None
    currency_name: Optional[StrictStr] = Field(default=None, description="Currency name for the currency used by this piggy bank. This will always be the currency of the piggy bank, never the user's native currency.")
    currency_decimal_places: Optional[StrictInt] = Field(default=None, description="Number of decimal places for the currency used by this piggy bank. This will always be the currency of the piggy bank, never the user's native currency.")
