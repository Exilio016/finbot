...
class AutocompleteAccount(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "name_with_balance", "type", "currency_id", "currency_name", "currency_code", "currency_symbol", "currency_decimal_places", "account_currency_id", "account_currency_name", "account_currency_code", "account_currency_symbol", "account_currency_decimal_places"]
