...
class Currency(BaseModel):
    ...
    default: Optional[StrictBool] = Field(default=None, description="Make this currency the native currency.")
    native: Optional[StrictBool] = Field(default=None, description="Make this currency the native currency.")
    code: StrictStr
    name: StrictStr
    symbol: StrictStr
    decimal_places: Optional[StrictInt] = Field(default=None, description="Supports 0-16 decimals.")
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "enabled", "default", "native", "code", "name", "symbol", "decimal_places"]
