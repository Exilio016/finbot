...
class AutocompletePiggyBalance(BaseModel):
    ...
    currency_id: Optional[StrictStr] = Field(default=None, description="Currency ID for the currency used by this piggy bank. This will always be the piggy bank's currency, never the native currency.")
    currency_code: Optional[StrictStr] = Field(default=None, description="Currency code for the currency used by this piggy bank. This will always be the piggy bank's currency, never the native currency.")
    currency_symbol: Optional[StrictStr] = Field(default=None, description="Currency symbol for the currency used by this piggy bank. This will always be the piggy bank's currency, never the native currency.")
    currency_decimal_places: Optional[StrictInt] = Field(default=None, description="Currency decimal places for the currency used by this piggy bank. This will always be the piggy bank's currency, never the native currency.")
