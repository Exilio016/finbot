...
class Budget(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "name", "active", "notes", "order", "auto_budget_type", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places", "native_currency_id", "native_currency_code", "native_currency_symbol", "native_currency_decimal_places", "auto_budget_amount", "native_auto_budget_amount", "auto_budget_period", "spent"]
