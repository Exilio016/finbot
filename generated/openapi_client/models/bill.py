...
class Bill(BaseModel):
    ...
    native_amount_min: Optional[StrictStr] = Field(default=None, description="The max amount of this bill in the user's native currency, if the original amount is in a different currency.")
    native_amount_max: Optional[StrictStr] = Field(default=None, description="The min amount of this bill in the user's native currency, if the original amount is in a different currency.")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places", "native_currency_id", "native_currency_code", "native_currency_symbol", "native_currency_decimal_places", "name", "amount_min", "amount_max", "native_amount_min", "native_amount_max", "date", "end_date", "extension_date", "repeat_freq", "skip", "active", "order", "notes", "next_expected_match", "next_expected_match_diff", "object_group_id", "object_group_order", "object_group_title", "pay_dates", "paid_dates"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if native_amount_min (nullable) is None
        # and model_fields_set contains the field
        if self.native_amount_min is None and "native_amount_min" in self.model_fields_set:
            _dict['native_amount_min'] = None

        # set to None if native_amount_max (nullable) is None
        # and model_fields_set contains the field
        if self.native_amount_max is None and "native_amount_max" in self.model_fields_set:
            _dict['native_amount_max'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "native_amount_min": obj.get("native_amount_min"),
            "native_amount_max": obj.get("native_amount_max"),
            "date": obj.get("date"),
