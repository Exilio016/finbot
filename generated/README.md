...
*CurrencyExchangeRatesApi* | [**list_currency_exchange_rates**](docs/CurrencyExchangeRatesApi.md#list_currency_exchange_rates) | **GET** /v1/exchange-rates | List all exchange rates.
